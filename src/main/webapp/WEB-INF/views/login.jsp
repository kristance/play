...
<form id="loginForm" action="gate" class="container" method="POST">
	...
	<div class="w-100 container px-0" style=" height: 83vh;">			
		...
		<div class="w-100 row mx-0" style=" height: 70px">
			...
			<input id="status" name="status" type="text" value="${status }" style="display: none">
<!-- id -->
...
<!-- login button -->		
		<div class="w-100 row mx-0" style=" height: 50px">
			...
			<div class="col-4 h-100 text-white text-center pt-1 fs-4 fw-bold bg-black rounded-pill" 
				style=" cursor: pointer; " onclick="loginButton()">
				* Login
			</div>
			<div class="col-4" >
			</div>
		...
		<div class="w-100 row mx-0" style=" height: 50px">
			<div class="col-4"></div>
			<div class="col-4 border border-black rounded-pill fs-4 fw-bold text-center pt-2" style="cursor: pointer;" onclick="location.href='anonymous?status=${status}'">
				* 비회원 예약 확인
			</div>
			<div class="col-4"></div>
		</div>
