...
<script type="text/javascript" src="./js/searchIdPasswordForPass.js" defer="defer"></script>

</head>
<body class="mx-0 my-0 px-0 py-0">

<div class=" my-5 d-flex justify-content-center align-self-center">
	<div class="container text-center py-0" style=" width: 500px; height: 500px" >
			...
			<div class="w-100 row mx-0 px-0" style="height: 50px">
				...
				onclick="location.href='searchIdPasswordForId'" style="cursor: pointer;">
					 아이디 찾기 
				</div>
				<br/>
				<br/>
			...
			<table class="w-100" style="height: 200px">
				<tr>
					...
					<td class="w-75" style=" height: 80px">
						<input id="id" class="form-control fs-4" type="text" style="border: 2px solid black; height: 50px">
					</td>
				</tr>
				<tr>
					<td class="w-25 fs-3 fw-bold" style=" height: 80px">
				...
				<tr>
					<td style=" height: 45px;" colspan="2"> 
						...
						<div class="h-100 pt-1 fs-4 fw-bold rounded-pill"
							style=" width: 200px; display: inline-block; cursor: pointer;"
							onclick="self.close()">
							취소
						</div>
